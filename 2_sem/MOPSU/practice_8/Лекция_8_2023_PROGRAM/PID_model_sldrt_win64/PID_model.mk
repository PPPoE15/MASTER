...
MODEL                := PID_model
MODULES              := PID_model_data.c PID_model_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := PID_model_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/RT1;C:/RT1/PID_model_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src

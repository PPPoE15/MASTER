...
MODEL                := sldrtex_PLC_reg
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c sldrtex_PLC_reg_data.c sldrtex_PLC_reg_tgtconn.c
MAKEFILE             := sldrtex_PLC_reg.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := sldrtex_PLC_reg_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/RT1;C:/RT1/sldrtex_PLC_reg_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
